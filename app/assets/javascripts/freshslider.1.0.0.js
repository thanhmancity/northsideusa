...
(function($){
    ...
    $.fn.freshslider = function(options){
        ...
        if(range){
            var selectorUi = this.selector.replace('#','');
            selectorUi = selectorUi.replace('.','');
            view = this.html("<div class='fsslider'><div class='fsfull-value'></div>" +
                "<input type='hidden'>" +
                "<div class='fssel-value' id='" + selectorUi + "'></div><div class='fscaret fss-left'></div>" +
            ...
            view = this.html("<div class='fsslider'><div class='fsfull-value'></div>" +
                "<input type='hidden'>" +
                "<div class='fssel-value' id='" + selectorUi + "'></div><div class='fscaret'></div></div>")
                .find('.fsslider');
        }
